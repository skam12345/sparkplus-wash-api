const selectcouponlist = (coupon_type, is_use, publish_type, car_no) =>`
...
WHERE 1=1 
AND a.cin_coupon_type = "${coupon_type}%"
AND a.cin_is_use = "${is_use}%"
AND a.cin_publish_type = "${publish_type}%"
AND a.cin_car_no LIKE "%${car_no}%"
ORDER BY a.cin_reg_date DESC, a.cin_use_date DESC 
 `

module.exports = selectcouponlist;