const selectcouponlistasuse =(start_date, end_date, coupon_type, is_use, publish_type, car_no, start_count, view_count) =>`
...
WHERE 1=1 
AND LEFT(a.cin_use_date,10) >= "${start_date}" AND LEFT(a.cin_use_date,10) <= "${end_date}"
...
module.exports = selectcouponlistasuse;