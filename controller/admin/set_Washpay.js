...
const payinsertpaydata = require('../../query/admin/set_washpay/pay_insert_paydata');
const payselectFleet = require('../../query/admin/set_washpay/pay_select_fleet');
const payselectMembership = require('../../query/admin/set_washpay/pay_select_membership');
