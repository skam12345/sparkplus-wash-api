...
const sendtemppw = require('../../biztalk_data/send_temppw');


module.exports.sendtemppw = (req, res) =>{
    let phone_no = req.body.phone_no;
    let temp_pwd = req.body.temp_pwd;
    let data = sendtemppw(temp_pwd);
