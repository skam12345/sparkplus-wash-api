...
const sendapprovalfleetmember = require('../../biztalk_data/send_approvalfleetmember');


module.exports.approvalfleetmember = (req, res) =>{
    let fleet_id = req.body.fleet_id;
    let phone_no = req.body.phone_no;
    let approval_date = req.body.approval_date;
    let data = sendfmember(fleet_id, phone_no, approval_date);
...
var jsonData = {bsid : 'moonsong_1', passwd : '66bb3ae17994de9fc99b93178f94b573cedc3e5b'};
    ...
    function(error,response,body){
        ...
        request.post({
            ...
            body : {
            "msgIdx":approval_date+fleet_id+phone_no,
            "countryCode":"82",
            "resMethod":"PUSH",
            "senderKey":"a54e05f52d5402b3472b097e8b017b46d5f6a278",
            "tmpltCode":"approvalfleetmember",
            "message": data,
            "recipient": phone_no,
            "attach":{
